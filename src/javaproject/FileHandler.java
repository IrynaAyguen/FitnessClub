...
public class FileHandler {
    ...
    public LinkedList<Member> readFile(){   // читает из ф-ла members.csv инфо о всех посетителях
    ...
    public void appendFile(String mem){  //присоединяет нов.строку к файлу members.csv, когда доб-ся новый посетитель
    ...
    public void overwriteFile(LinkedList<Member> m) {   //  при удалении посетителя из клуба из LinkedList создается
        // временный ф-л members.temp и переименовывается в members.csv
        String s;
